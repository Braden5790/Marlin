...
#define STRING_CONFIG_H_AUTHOR "(@bradens3dprints, Ender-5-Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Braden's E5P"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 10, 10, 0 } // NEED TO EDIT
